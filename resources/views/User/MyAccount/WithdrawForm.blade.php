      ...
      <div class="row">
        <div class="inner-content">
          <div class="col-sm-12"> 
              ...
              <div class="col-sm-10">
                  <div class="row">
                    <center><h2>Withdraw Form</h2></center>
                      <div class="col-sm-offset-4 col-sm-4">  
                          <form action="<?php echo url('my-account/withdraw') ?>" method="post">
                            {{ csrf_field() }}
                            ...
                            @endif
                              ...
                              <div class="form-group">
                                <label>Enter Withdraw Amount</label><span class="RequiredData">*</span>
